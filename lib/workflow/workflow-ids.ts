...
export const MULTI_PLATFORM_SCRIPT_JOB_TYPE = 'multi_platform_script'
export const HIGHLIGHTS_EXTRACTION_JOB_TYPE = 'highlights_extraction'
...
export const MULTI_PLATFORM_SCRIPT_WORKFLOW_ID = 'multi-platform-script'
export const HIGHLIGHTS_EXTRACTION_WORKFLOW_ID = 'highlights-extraction'
...
export const MULTI_PLATFORM_SCRIPT_ENDPOINT = '/api/script-rewrite'
export const HIGHLIGHTS_EXTRACTION_ENDPOINT = '/api/highlights'
...
export type MainlineJobType =
  ...
  | typeof MULTI_PLATFORM_SCRIPT_JOB_TYPE
  | typeof HIGHLIGHTS_EXTRACTION_JOB_TYPE
...
export type MainlineWorkflowId =
  ...
  | typeof MULTI_PLATFORM_SCRIPT_WORKFLOW_ID
  | typeof HIGHLIGHTS_EXTRACTION_WORKFLOW_ID
...
export type MainlineJobCreationEndpoint =
  ...
  | typeof MULTI_PLATFORM_SCRIPT_ENDPOINT
  | typeof HIGHLIGHTS_EXTRACTION_ENDPOINT
...
export const JOB_TYPE_TO_WORKFLOW_ID = {
  ...
  [MULTI_PLATFORM_SCRIPT_JOB_TYPE]: MULTI_PLATFORM_SCRIPT_WORKFLOW_ID,
  [HIGHLIGHTS_EXTRACTION_JOB_TYPE]: HIGHLIGHTS_EXTRACTION_WORKFLOW_ID,
...
export const WORKFLOW_ID_TO_JOB_TYPE = {
  ...
  [MULTI_PLATFORM_SCRIPT_WORKFLOW_ID]: MULTI_PLATFORM_SCRIPT_JOB_TYPE,
  [HIGHLIGHTS_EXTRACTION_WORKFLOW_ID]: HIGHLIGHTS_EXTRACTION_JOB_TYPE,
...
export const JOB_TYPE_TO_CREATION_ENDPOINT = {
  ...
  [MULTI_PLATFORM_SCRIPT_JOB_TYPE]: MULTI_PLATFORM_SCRIPT_ENDPOINT,
  [HIGHLIGHTS_EXTRACTION_JOB_TYPE]: HIGHLIGHTS_EXTRACTION_ENDPOINT,
